...
<body>
    ...
    <h2>Registro Nuevo Operario</h2>

            <form action="index.php?action=create" method="POST" enctype="multipart/form-data"> <!--enctype="multipart/form-data" permite que los datos del formulario se dividan en múltiples partes, y cada parte puede contener un tipo de dato diferente (texto o archivo).-->
                ...
                <br>
                <div class="form-group row">
                    <label for="staticEmail" class="col-sm-1 col-form-label">Contrasena</label>
                    <div class="col-sm-6">
