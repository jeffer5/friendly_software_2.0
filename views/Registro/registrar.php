    ...
    <h2 id="tittle">Registro Nuevo Supervisor</h2>
        ...
        <div class="manzana">
            <form class="form-re"  action="index.php?action=registrar" method="POST" enctype="multipart/form-data"> <!--enctype="multipart/form-data" permite que los datos del formulario se dividan en múltiples partes, y cada parte puede contener un tipo de dato diferente (texto o archivo).-->
                ...
                <br>
                <div class="form-group row">
                    <label for="exampleFormControlSelect1" class="col-sm-2 col-form-label">Tipo de documento</label>
                    <div class="col-sm-10">
                ...
                <br>
                <div class="form-group row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Numero de documento</label>
                    <div class="col-sm-10">
                ...
                <br>
                <div class="form-group row">
                    <label for="exampleFormControlSelect1" class="col-sm-2 col-form-label">Rol usuario</label>
                    <div class="col-sm-10">
